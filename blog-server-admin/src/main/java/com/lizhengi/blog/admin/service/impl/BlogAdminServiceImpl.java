package com.lizhengi.blog.admin.service.impl;
...
import com.lizhengi.blog.blog.service.BlogAdminService;
import com.lizhengi.blog.blog.manager.BlogArticleManager;
import com.lizhengi.blog.blog.manager.BlogColumnManager;
import com.lizhengi.blog.blog.manager.BlogDirectionManager;
import com.lizhengi.blog.blog.manager.BlogThemeManager;
...
public class BlogAdminServiceImpl implements BlogAdminService {
    ...
    public List<BlogThemeListVO> listTheme(BlogThemeListDTO dto) {
        ...
        queryWrapper.eq( BlogThemeEntity::getId, dto.getId());
    ...
    public List<BlogDirectionListVO> listDirection(BlogDirectionListDTO dto) {
        ...
        queryWrapper.eq(BlogDirectionEntity::getId, dto.getId());
    ...
    public List<BlogColumnListVO> listColumn(BlogColumnListDTO dto) {
        ...
        queryWrapper.eq(BlogColumnEntity::getId, dto.getId());
    ...
    public List<BlogArticleListVO> listArticle(BlogArticleListDTO dto) {
        ...
        queryWrapper.eq(BlogArticleEntity::getId, dto.getId());
